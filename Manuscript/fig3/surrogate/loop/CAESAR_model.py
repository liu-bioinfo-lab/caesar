...
from tensorflow.keras.layers import Layer, Dense, Input, Conv1D, Flatten, Dot, BatchNormalization, Concatenate, Permute, Add, Multiply
...
def CAESAR_loop(nBins=1250, nMarks=6, verbose=1, lr=0.0001, positional_dim=8,
    ...
    # GC Layers
    gc_layers = [
        BatchNormalization(name=f'GC_0_BN')(
    ...
    for i in range(n_GC_layers):
        gc_layers.append(
            BatchNormalization(name=f'GC_{i + 1}_BN')(
