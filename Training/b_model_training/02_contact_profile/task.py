...
def train_and_evaluate(processed_path, HiC_cell_lines, MicroC_cell_line,
                       epoches=5, batch_size=10, checkpoint_frequency=1):
    # Build current model
    model = CAESAR()
    ...
    # Training set: chr1,4,7,10,13,17,18
    ...
    generator = training_data_generator(ch_coord, HiC_cell_lines, MicroC_cell_line, epi_names, processed_path=processed_path,
