...
def predict_region(
    ...
    pred = np.exp(pred) - 1
    visualize_HiC_epigenetics(pred, epi_original, f'{ch}_{pos}_pred.png', colorbar=True,
    ...
    visualize_HiC_epigenetics(hic, epi_original, f'{ch}_{pos}_hic.png', colorbar=True,
                              interval_after_heatmap=0.,
                              interval_between_epi=0., epi_labels=epi_names,
                              epi_yaxis=False, fontsize=20, epi_ratio=0.045,
